...
import FloorPlanDisplay from "./floorplan";
import MoreInfo from "./MoreInfo"; // Import the "More Information" component
  ...
  return (
    <Router>
      <div className="App">
        ...
        {/* Main Routes */}
        <Routes>
          {/* Route for the floorplan */}
          <Route path="/" element={<FloorPlanDisplay />} />
          ...
          <div style={contentContainerStyle}>
            ...
            <div style={textContainerStyle}>
              ...
              <div style={normalSpacingStyle}>
                <p>
                  Tel: <span style={highlightStyle}>+44 (0)1224 272000</span>
                </p>
